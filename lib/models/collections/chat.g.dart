...
const ChatSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'historyMessages': PropertySchema(
      id: 1,
      name: r'historyMessages',
      type: IsarType.long,
    ),
...
void _chatSerialize(
  ...
  writer.writeLong(offsets[1], object.historyMessages);
...
Chat _chatDeserialize(
  ...
  object.historyMessages = reader.readLong(offsets[1]);
  object.id = id;
...
extension ChatQueryFilter on QueryBuilder<Chat, Chat, QFilterCondition> {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> historyMessagesEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'historyMessages',
        value: value,
      ));
    });
  }

  QueryBuilder<Chat, Chat, QAfterFilterCondition> historyMessagesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> historyMessagesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> historyMessagesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'provider',
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'provider',
        value: '',
  ...
  QueryBuilder<Chat, Chat, QAfterFilterCondition> providerIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'provider',
        value: '',
...
extension ChatQuerySortBy on QueryBuilder<Chat, Chat, QSortBy> {
  ...
  QueryBuilder<Chat, Chat, QAfterSortBy> sortByHistoryMessages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'historyMessages', Sort.asc);
    });
  }

  QueryBuilder<Chat, Chat, QAfterSortBy> sortByHistoryMessagesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'historyMessages', Sort.desc);
    });
  }
  ...
  QueryBuilder<Chat, Chat, QAfterSortBy> sortByProvider() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'provider', Sort.asc);
    });
  }

  QueryBuilder<Chat, Chat, QAfterSortBy> sortByProviderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatQuerySortThenBy on QueryBuilder<Chat, Chat, QSortThenBy> {
  ...
  QueryBuilder<Chat, Chat, QAfterSortBy> thenByHistoryMessages() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'historyMessages', Sort.asc);
    });
  }

  QueryBuilder<Chat, Chat, QAfterSortBy> thenByHistoryMessagesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'historyMessages', Sort.desc);
    });
  }
  ...
  QueryBuilder<Chat, Chat, QAfterSortBy> thenByProvider() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'provider', Sort.asc);
    });
  }

  QueryBuilder<Chat, Chat, QAfterSortBy> thenByProviderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'provider', Sort.desc);
    });
  }
...
extension ChatQueryWhereDistinct on QueryBuilder<Chat, Chat, QDistinct> {
  ...
  QueryBuilder<Chat, Chat, QDistinct> distinctByHistoryMessages() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'historyMessages');
    });
  }
  ...
  QueryBuilder<Chat, Chat, QDistinct> distinctByProvider(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatQueryProperty on QueryBuilder<Chat, Chat, QQueryProperty> {
  ...
  QueryBuilder<Chat, int, QQueryOperations> historyMessagesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'historyMessages');
    });
  }
  ...
  QueryBuilder<Chat, String, QQueryOperations> providerProperty() {
    return QueryBuilder.apply(this, (query) {
